...
from core.database import (
    get_db, get_whitelist, add_to_whitelist, remove_from_whitelist,
    get_all_usage, get_blacklist, add_to_blacklist, remove_from_blacklist, DAILY_LIMIT_BYTES
)
...
def admin_login():
    ...
    if _is_rate_limited(ip):
        ...
        return _render_login(error, captcha_enabled)
...
def _render_login(error: str, captcha_enabled: bool):
...
def _get_task_stats(conn) -> Dict[str, int]:
    return {
...
@login_required
def remove_blacklist_route(ip: str):
    try:
