...
Pastikan DNS `A`/`AAAA` domain sudah mengarah ke server, lalu aktifkan konfigurasi HTTP awal dan biarkan Certbot menambahkan konfigurasi SSL:
...
sudo certbot --nginx --redirect -d getfetchly.online
```
